...
PLAN_PATH = os.path.join('promopts','plan')


with open (os.path.join(DEFAULT_PATH,'ORCHESTRATOR.md'),'r',errors='ignore') as f:
...
with open (os.path.join(DEFAULT_PATH,'CODER.md'),'r',errors='ignore') as f:
...
with open (os.path.join(DEFAULT_PATH),'PLANNER.md','r',errors = 'ignore') as f:
    PLANNER_PROMPT_BASE = f.read()
PLANNER_PROMPT = PLANNER_PROMPT_BASE + "\n严格输出 JSON 格式：\n```json\n{\n    \"Plan\": [\n        \"第一步：分析xxx文件并编写yyy的测试代码\",\n        \"第二步：运行该测试代码，确保没有报错\"\n    ]\n}\n```\n"

with open (os.path.join(DEFAULT_PATH),'STUDENT_PLANNER.md',errors='ignore') as f:
...
with open (os.path.join(DEFAULT_PATH, 'CRITIC.md'),'r',errors='ignore') as f:
...
with open (os.path.join(EXECUTE_PATH, 'PERFORM_EXPERIMENT'),'r',errors='ignore') as f:
...
with open (os.path.join(PLAN_PATH, 'PERFORM_EXPERIMENT_STUDENT'),'r',errors = 'ignore') as f:
...
##################################### Review #####################################
with open (os.path.join(EXECUTE_PATH, 'REVIEW_PDF'),'r', errors = 'ignore') as f:
...
##################################### Update from Review #####################################
with open (os.path.join(EXECUTE_PATH,'UPDATE_FROM_REVIEW.md'),'r',errors='ignore') as f:
...
with open (os.path.join(PLAN_PATH,'UPDATE_FROM_REVIEW_STUDENT.md'),'r',errors='ignore') as f:
...
##################################### Code Generation #####################################
with open (os.path.join(EXECUTE_PATH, 'GENERATE_CODE.md'),'r',errors='ignore') as f:
...
with open (os.path.join(PLAN_PATH, 'CODER_STUDENT.md'),'r',errors = 'ignore') as f:
...
################################### Paper writeup #######################################
with open(os.path.join(PLAN_PATH, 'PERFORM_WRITEUP_STUDENT'),'r',errors='ignore') as f:
...
with open(os.path.join(EXECUTE_PATH, 'PERFORM_WRITEUP_STUDENT'),'r',errors='ignore') as f:

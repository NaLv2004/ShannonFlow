...
with open (os.path.join(DEFAULT_PATH,'STUDENT_PLANNER.md'),'r',errors='ignore') as f:
...
with open (os.path.join(EXECUTE_PATH, 'PERFORM_EXPERIMENT.md'),'r',errors='ignore') as f:
...
with open (os.path.join(PLAN_PATH, 'PERFORM_EXPERIMENT_STUDENT.md'),'r',errors = 'ignore') as f:
...
##################################### Review #####################################
with open (os.path.join(EXECUTE_PATH, 'REVIEW_PDF.md'),'r', errors = 'ignore') as f:
...
################################### Paper writeup #######################################
with open(os.path.join(PLAN_PATH, 'PERFORM_WRITEUP_STUDENT.md'),'r',errors='ignore') as f:
...
with open(os.path.join(EXECUTE_PATH, 'PERFORM_WRITEUP.md'),'r',errors='ignore') as f:

...
PHASES = ["1_Generate_Ideas", "2_Generate_Code", "3_Perform_Experiments", "4_Writeup", "5_Review", "6_Update_From_Reviews"]
...
async def start():
    ...
    await cl.ChatSettings([
        ...
        TextInput(id="conda_env", label="🐍 Conda 运行环境", initial="AutoGenOld"),
